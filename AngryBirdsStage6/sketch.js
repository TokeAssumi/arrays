...
//NUMBERS: Any mathematical number.
var num = 10;
console.log(num);
...
console.log(object);
//Examples on ARRAY
/*An array is created inside square brackets and can store a list of the same or different types of data separated by a comma.
